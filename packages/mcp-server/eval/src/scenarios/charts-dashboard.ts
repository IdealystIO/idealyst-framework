...
1. **Revenue Line Chart** — Use @idealyst/charts LineChart to show monthly revenue data over the past 12 months with axis labels
...
Look up the charts documentation to understand the data format and chart props before writing code.`,
  expectedToolUsage: [
    "get_charts_guide",
    "get_component_docs",
    "get_component_types",
