...
/**
 * Handle the `idealyst info` command
 */
...
function printTextInfo(): void {
  ...
  console.log(chalk.blue.bold('  Idealyst CLI'));
  console.log(chalk.blue.bold('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n'));
  ...
  console.log(chalk.white('    idealyst init my-app'));
  console.log('');
  console.log(chalk.dim('    # Non-interactive with all options'));
  console.log(chalk.white('    idealyst init my-app --no-interactive \\'));
  ...
  console.log(chalk.white('    idealyst add admin --type web'));
  console.log('');
}
  ...
  const info = {
    ...
    commands: {
      init: {
        ...
        usage: 'idealyst init [project-name]',
        options: [
      ...
      add: {
        ...
        usage: 'idealyst add <name> --type <type>',
...
# Non-interactive
idealyst init my-app --no-interactive \\
  --org-domain com.company \\
  --app-name "My App" \\
  --with-api --with-trpc

# Add project to workspace
idealyst add admin --type web
\`\`\`
`);
}
...
function printLlmInfo(): void {
  console.log(`IDEALYST CLI - SAFE COMMANDS FOR LLM USAGE
...
1. Initialize workspace with all options:
   idealyst init <name> --no-interactive --org-domain <domain> --app-name "<name>"

2. Initialize with extensions:
   idealyst init <name> --no-interactive --org-domain <domain> --app-name "<name>" --with-api --with-trpc --with-prisma

3. Add project to workspace:
   idealyst add <name> --type web
   idealyst add <name> --type mobile --app-name "<name>"
   idealyst add <name> --type api
   idealyst add <name> --type shared
...
EXAMPLE:
idealyst init my-app --no-interactive --org-domain com.mycompany --app-name "My App" --with-api --with-trpc --with-prisma --skip-install
`);
}
