...
const ExampleNavigationRouter: NavigatorParam = {
    ...
    routes: [
        ...
        { path: "stylebuilder-test", type: 'screen', component: StyleBuilderTestExamples, options: { title: "StyleBuilder Test" } },
    ],
};
