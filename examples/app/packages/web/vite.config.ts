...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // Tiptap packages - resolve from web app's node_modules to avoid peer dep issues
      ...
      '@tiptap/extension-task-list': path.resolve(__dirname, 'node_modules/@tiptap/extension-task-list'),
      '@tiptap/extension-task-item': path.resolve(__dirname, 'node_modules/@tiptap/extension-task-item'),
      ...
      '@idealyst/animate': path.resolve(__dirname, '../../../../packages/animate/src'),
      '@idealyst/lottie': path.resolve(__dirname, '../../../../packages/lottie/src'),
      '@idealyst/markdown/editor': path.resolve(__dirname, '../../../../packages/markdown/src/Editor'),
